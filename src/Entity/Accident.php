...
class Accident
{
    ...
    public function getMailAssureur(): ?string
    {
        return $this->Mail_Assureur;
    }

    public function setMailAssureur(string $Mail_Assureur): self
    {
        $this->Mail_Assureur = $Mail_Assureur;
